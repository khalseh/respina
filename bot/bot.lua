...
chats = {}
plugins = {}
helper_username = 'ketmaanBot'  -- Input Helper Username Here Without @
...
function create_config( )
  ...
  -- A simple config with basic plugins and ourselves as privileged user
    ...
    sudo_users = {477813517,362834029,328658415, sudo_id},
    admins = {},
    disabled_channels = {},
    moderation = {data = './data/moderation.json'},
    info_text = [[》KETMAN BOT
