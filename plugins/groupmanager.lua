...
local function found_helper(TM, ketman)
...
tdcli.getInlineQueryResults(ketman.id_, msg.to.id, 0, 0, msg.to.id, 0, inline_query_cb, nil)
end
...
--end groupmanager.lua #ketmanteam#
