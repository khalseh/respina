...
local text = matches[2]
tdcli.createNewChannelChat(text, 1, '@KetmaaN', (function(b, d) tdcli.addChatMember(d.id_, msg.from.id, 0, dl_cb, nil) end), nil)
   if not lang then 
...
if ((matches[1] == 'ketman' and not Clang) or (matches[1] == "کتمان" and Clang)) then
...
_Sudoer And Admins ketman Bot Help :_
...
text = [[
_راهنمای ادمین و سودو های ربات کتمان:_
